...
public class SpotifyExplorer {
    ...
    public int getArtistActiveYears(String artist) {
        ...
        IntSummaryStatistics statistics = spotifyTracks.stream()
                ...
                .summaryStatistics(); // terminal operation -> returns an IntSummaryStatistics describing various summary data about the elements of this stream like count of number of elements in the IntStream, average of all elements present in IntStream, minimum and maximum element in the IntStream and so on
